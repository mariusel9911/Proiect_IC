...
export const useProviderStore = create((set, get) => ({
    ...
    fetchProviders: async (filters = {}) => {
        try {
            ...
            try {
                ...
                console.log("Error fetching providers from API, falling back to mock data:", error.message);
            }
            ...
            const mockProviders = [
                {
                    ...
                    description: 'Experienced professional with 10+ years in the cleaning industry',
                    price: 'FREE',
                    type: 'person',
                    rating: 4.8,
                    isPopular: true,
                ...
                },
                {
                    ...
                    description: 'Leading company providing comprehensive cleaning solutions for homes and offices',
                    price: 'FREE',
                    type: 'company',
                    rating: 4.5,
                    isVerified: true,
                ...
                },
                {
                    ...
                    description: 'Specialized in eco-friendly cleaning solutions for environmentally conscious clients',
                    price: 'FREE',
                    type: 'company',
                    rating: 4.7,
                    isPopular: true,
    ...
    fetchProviderById: async (providerId) => {
        try {
            ...
            try {
                ...
                console.log("Error fetching provider from API, falling back to mock data:", error.message);
            }
    ...
    fetchProvidersForService: async (serviceId) => {
        try {
            ...
            // Try API first
            try {
                const response = await axios.get(`${API_URL}/providers/service/${serviceId}`);
                ...
                console.log("Error fetching service providers from API, falling back to mock data:", error.message);
            }
            ...
            set({
                isLoading: false,
                error: error.response?.data?.message || 'Failed to fetch service providers'
            });
            return [];
        }
    },
