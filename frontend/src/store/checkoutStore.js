...
export const useCheckoutStore = create(
  persist(
    (set, get) => ({
      ...
      paypalOrderId: null, // To store PayPal order ID
      ...
      // Calculate tax (20%)
      calculateTax: () => {
        return Math.round(get().calculateTotal() * 0.2 * 100) / 100; // Round to 2 decimal places
      },
      ...
      validateCardDetails: () => {
        ...
        if (get().paymentMethod !== 'card') return true;
