...
import { User, Settings, ClipboardList, LogOut, Camera, ChevronLeft, ExternalLink, X } from 'lucide-react';
...
const ProfilePage = () => {
    ...
    const fetchUserData = async () => {
        ...
        try {
            // Fetch user address
            const addressResponse = await fetch('http://localhost:5000/api/users/address', {
                method: 'GET',
                headers: {
    ...
    const handleSaveChanges = async () => {
        ...
        try {
            ...
            // This is a simplistic approach - you may need a more robust parsing
    ...
    // Get payment status color class - THIS WAS MISSING
                    ...
                    <div className="md:w-1/3">
                        <div className="bg-white rounded-lg shadow-md p-6 text-center">
                            ...
                            <div className="relative mx-auto mb-4">
                                ...
                                <label htmlFor="profile-image-upload" className="absolute bottom-0 right-0 md:right-[calc(50%-3rem)] bg-blue-500 hover:bg-blue-600 text-white p-1 rounded-full cursor-pointer transition-colors">
                                    <Camera size={16} />
                                    <input
                                            ...
                                            {orders.map((order) => (
                                                ...
                                                >
                                                    <div className="flex justify-between items-start mb-2">
                                                        <div>
                                                            <h4 className="font-medium">{order.service?.name || 'Service'}</h4>
                            ...
                            <span className={`inline-block px-2 py-1 rounded-full text-xs font-medium ${getStatusClass(order.status)}`}>
                              {order.status}
                                                    ...
                                                    <div className="flex justify-between items-center">
                                                        <p className="font-medium text-gray-900">{order.grandTotal} RON</p>
            ...
            {selectedOrder && (
                ...
                {selectedOrder.status}
                            ...
                            <div className="flex justify-between items-center py-2 border-b">
                                ...
                                <span className={`px-2 py-1 rounded-full text-xs font-medium ${getPaymentStatusClass(selectedOrder.paymentStatus)}`}>
                {selectedOrder.paymentStatus}
                        ...
                        {option.quantity} x {option.price || ''}
                            ...
                            <div className="flex justify-between items-center py-2 border-b">
                                ...
                                <span className="font-bold">{selectedOrder.grandTotal} RON</span>
                            </div>
