...
const CheckoutPage = () => {
  ...
  useEffect(() => {
    ...
    setIsLoading(false);
  }, [serviceId, selectedService, initialService, navigate, setSelectedService]);
      ...
      <div className="min-h-screen bg-gradient-to-b from-blue-50 to-purple-50 flex flex-col items-center justify-between">
        <div className="w-full bg-white flex flex-col">
          <div className="w-full p-3 bg-white shadow-lg flex justify-center items-center">
            <Link
                to={`/cleaning/${serviceId || selectedService._id || selectedService.id}`}
                ...
                <div className="space-y-6">
                  ...
                  <div className="mb-6 bg-gray-50 p-4 rounded-lg">
                    ...
                    <div className="flex justify-between items-center mt-2">
                      <span className="text-green-600 font-bold">{selectedService.type}</span>
                    </div>
                  </div>
                  ...
                  <div className="border-b border-gray-200 pb-6">
                    ...
                    <div className="space-y-4">
                      <Input
                          ...
                          onChange={handleInputChange}
                          error={showErrors && !address.street ? "Address is required" : null}
                          required
                      />
                      ...
                      <div className="grid grid-cols-2 gap-4">
                        <Input
                            ...
                            value={address.city}
                            onChange={handleInputChange}
                            error={showErrors && !address.city ? "City is required" : null}
                            required
                        />
                        ...
                        <Input
                            ...
                            onChange={handleInputChange}
                            error={showErrors && !address.zipCode ? "Zip code is required" : null}
                            required
                        />
                      </div>
                      ...
                      <Input
                          ...
                          onChange={handleInputChange}
                          error={showErrors && !address.country ? "Country is required" : null}
                          required
                      />
                    </div>
                  </div>
                  ...
                  <div className="border-b border-gray-200 pb-6">
                    ...
                    <div className="space-y-4">
                      <Input
                          ...
                          onChange={handleInputChange}
                          error={showErrors && !cardDetails.name ? "Name is required" : null}
                          required
                      />
                      ...
                      <Input
                          ...
                          onChange={handleInputChange}
                          error={showErrors && (!cardDetails.cardNumber || cardDetails.cardNumber.replace(/\s/g, '').length !== 16) ? "Valid card number is required" : null}
                          required
                      />
                      ...
                      <div className="grid grid-cols-2 gap-4">
                        <Input
                            ...
                            onChange={handleInputChange}
                            error={showErrors && (!cardDetails.expiryDate || !/^\d{2}\/\d{2}$/.test(cardDetails.expiryDate)) ? "Valid expiry date required" : null}
                            required
                        />
                        ...
                        <Input
                            ...
                            onChange={handleInputChange}
                            error={showErrors && (!cardDetails.cvv || !/^\d{3,4}$/.test(cardDetails.cvv)) ? "Valid CVV required" : null}
                            required
                        />
                      </div>
                    </div>
